...
async function articlesController(req, res, next) {
    try {
        ...
        console.log(url)
        const similar = await axios.get(url, null, { 'User-Agent': 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Mobile Safari/537.36' })
